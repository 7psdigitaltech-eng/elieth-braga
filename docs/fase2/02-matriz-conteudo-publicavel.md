# Matriz de conteúdo publicável — MVP

| Tema | Situação | Pode entrar no MVP? | Formulação recomendada | Validação adicional |
|---|---|---:|---|---|
| Nome civil | Confirmado | Sim | Elieth de Fátima da Silva Braga | Não necessária |
...
| Usinas da Paz | Contexto institucional | Sim, com cuidado | Atuou na SEAC, pasta ligada à coordenação das Usinas da Paz | Não atribuir todos os resultados pessoalmente |
| Instagram e Facebook | Confirmados pela equipe | Sim | Links oficiais | Verificar URLs antes do lançamento |
| Pretensão eleitoral de 2026 | Interna e sensível | Não | — | Autorização expressa e revisão jurídica |
| Família, religião e vida pessoal | Autorizadas para pesquisa | Somente após seleção | Conteúdo humano e pessoal aprovado | Validação específica de Elieth |
| Fotos das redes | Origem e direitos pendentes | Somente com autorização | Usar arquivos originais autorizados | Identificar autoria e licença |
...
- fotografias sem origem conhecida;
- afirmação de autoria exclusiva sobre programas governamentais.
