export const siteContent = {
  publicName: "Elieth Braga",
  fullName: "Elieth de Fátima da Silva Braga",
  pageTitle: "Elieth Braga | Trajetória, Gestão Pública e Cidadania no Pará",
  pageDescription:
  ...
  social: {
    instagramHandle: "@eliethdefatima",
    facebookLabel: "Elieth de Fátima Braga"
  },
  navigation: [
  ...
  placeholders: {
    main: "[FOTO PRINCIPAL AUTORIZADA]",
    historical: "[FOTO HISTÓRICA AUTORIZADA]",
